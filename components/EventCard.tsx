    ...
    return (
        <Link href={`/events/${slug}`} id="event-card">
            ...
            <div className="datetime">
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clock7-icon lucide-clock-7"><path d="M12 6v6l-2 4"/><circle cx="12" cy="12" r="10"/></svg>
                    <p>{time}</p>
                </div>
            </div>
        </Link>
